...
public class OSM_Report {
	...
	public String getReportData() throws Exception {
		...
		System.out.println(responseForReport);
		in.close();
		...
		String requestXml = "<Query.Request/>";

		/*
		 * String request1 =
		 * "<Query.Request xmlns=\"urn:com:metasolv:oms:xmlapi:1\">"; String
		 * resquest2="<OrderState>open.running.in_progress</OrderState>"; String
		 * request3="</Query.Request>";
		 */

		// requestXml=request1+resquest2+request3;
