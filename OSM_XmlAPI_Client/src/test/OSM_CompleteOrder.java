...
public class OSM_CompleteOrder {
	...
	public String getCompleteOrderData() throws Exception {
		...
		String request1= "<CompleteOrder.Request xmlns=\"urn:com:metasolv:oms:xmlapi:1\">";
		String request2="<OrderID>"+orderId+"</OrderID>";
		String request3="<OrderHistID>"+HistOrderId+"</OrderHistID>";
		String request4="<Status>"+status+"</Status>";
		String request5="</CompleteOrder.Request>";
